#!/bin/bash
# B10 PLAY (B08 + z슬립 불감대 3mm + z sr램프 0.5). EP=/NOISE= 지원
# 특정 ep: EP=2800 bash play_b08.sh   |  지그노이즈: NOISE=2 bash play_b08.sh
R=$(ls -dt /home/leegyuwon/Documents/ManipTrans/runs/CapUnscrewArm_B10_2026* | head -1)
