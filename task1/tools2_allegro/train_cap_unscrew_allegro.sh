...
exp="CapUnscrewAllegro_${TAG}_${stamp}"
train_log="${LOG_DIR}/cap_unscrew_allegro_${TAG}_${stamp}.log"
...
if [[ "${PLAY}" == "1" ]]; then
  ...
  exp="CapUnscrewAllegro_${TAG}_PLAY_${stamp}"
...
exec env \
  ...
  CAP_GRASP_INIT_POSE="${INIT_POSE:-/home/leegyuwon/Documents/task1/tools2_allegro/poses/grasp_al_r50.json}" \
