#!/bin/bash
# B06 PLAY (스크래치, floor2 + slip2W7 + 저항시작 1.0). 최신 ckpt 자동.
# 지그 노이즈 기본 off. 켜려면 NOISE=2 bash play_b05.sh
CKPT=${CKPT:-$(ls -t /home/leegyuwon/Documents/ManipTrans/runs/CapUnscrewArm_B06_2026*/nn/last_*ep_*.pth | head -1)}
