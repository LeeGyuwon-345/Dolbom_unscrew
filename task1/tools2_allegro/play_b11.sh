#!/bin/bash
# B11 PLAY. EP=/NOISE= 지원
# 특정 ep: EP=2800 bash play_b08.sh   |  지그노이즈: NOISE=2 bash play_b08.sh
R=$(ls -dt /home/leegyuwon/Documents/ManipTrans/runs/CapUnscrewArm_B11_2026* | head -1)
