#!/bin/bash
# B08 PLAY (신 정본 + 저항계단0.3 + 지그노이즈). 최신 ckpt 자동.
# 특정 ep: EP=2800 bash play_b08.sh   |  지그노이즈: NOISE=2 bash play_b08.sh
R=$(ls -dt /home/leegyuwon/Documents/ManipTrans/runs/CapUnscrewArm_B08_2026* | head -1)
